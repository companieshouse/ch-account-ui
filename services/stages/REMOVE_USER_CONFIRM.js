    ...
    content: [
      {
        ...
        props: {
          ...
          testId: 'submitButton',
          warning: true,
          matomo: ['trackEvent', tokens('REMOVE_USER_CONFIRM.[2].PageHeading.doYouWantToRemoveUserDisplayNameS.analytics'), tokens('REMOVE_USER_CONFIRM.[8].ButtonGroup.removeAuthorisation')]
        }
      },
      {
        component: 'Button',
