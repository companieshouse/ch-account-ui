...
export const FORGEROCK_COMPANY_ENDPOINT = process.env.FORGEROCK_COMPANY_ENDPOINT || 'https://openam-companieshouse-uk-dev.id.forgerock.io/openidm/managed/alpha_organization/'
