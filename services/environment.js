...
export const FORGEROCK_TREE_WF_LOGIN = process.env.FORGEROCK_TREE_WF_LOGIN || 'CHWebFiling'
...
export const FORGEROCK_TREE_WF_COMPANY_SELECTION = process.env.FORGEROCK_TREE_WF_COMPANY_SELECTION || 'WFCompanySelection'
...
export const CH_REQUEST_AUTH_CODE_URL = process.env.CH_REQUEST_AUTH_CODE_URL || 'https://ewf.companieshouse.gov.uk//seclogin?tc=1'
