  ...
  CH_LOGIN_1: [
    {
      ...
      props: {
        title: 'Mewngofnodi i\'ch cyfrif Tŷ’r Cwmnïau'
      }
    },
    {
      component: 'PageHeading',
      props: {
        children: 'Mewngofnodi i\'ch cyfrif Tŷ’r Cwmnïau.'
      }
    },
    {
      ...
      props: {
        elementProps: {
          IDToken1: {
            ...
            hint: 'Rhaid i chi fewngofnodi i greu cyfrif Tŷ’r Cwmnïau.'
          },
          IDToken2: {
            formGroup: 'usernameAndPassword',
            label: 'Cyfrinair'
      ...
      content: [
        {
          component: 'LinkText',
          props: {
            children: 'Creu cyfrif Tŷ’r Cwmnïau',
      ...
      content: [
        {
          component: 'LinkText',
          props: {
            children: 'Rwyf wedi anghofio fy nghyfrinair',
