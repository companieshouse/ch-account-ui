...
export const CH_EWF_REQUEST_AUTH_CODE_URL = process.env.CH_REQUEST_AUTH_CODE_URL
export const CH_EWF_LEGACY_AUTH_URL = process.env.CH_EWF_LEGACY_AUTH_URL
export const CH_EWF_AUTHENTICATED_ENTRY_URL = process.env.CH_EWF_AUTHENTICATED_ENTRY_UR
